    ...
    class Program
    {
        static int Main(string[] args)
        {
            ...
            Option<bool> includeVisibleOutsideOfAssembly = new("--include-visible-outside",
                "Include all API's not just public APIs. Default is public only. Default is `false`.");
            ...
            rootCommand.SetHandler((InvocationContext context) =>
            {
                GenAPIApp.Run(new GenAPIApp.Context
                {
                    ...
                    IncludeVisibleOutsideOfAssembly = context.ParseResult.GetValueForOption(includeVisibleOutsideOfAssembly),
                });
            });
